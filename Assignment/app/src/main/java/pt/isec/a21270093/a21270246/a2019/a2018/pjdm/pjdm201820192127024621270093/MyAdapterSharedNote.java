...
public class MyAdapterSharedNote extends BaseAdapter {
    private MyApp app;
    private LayoutInflater li;

    public MyAdapterSharedNote(Application app, LayoutInflater li) {
        this.app = (MyApp)app;
        this.li = li;
    }
    ...
    @Override
    public int getCount() {
        return app.ListNotes.GetSharedNoteList().size();
    }

    @Override
    public Object getItem(int position) {
        return app.ListNotes.GetSharedNoteListItemInverted(position);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        try {
            ...
            if (item != null) {
                ...
                try {
                    NoteTitle = item.get(app.ListNotes.SharedNoteKeyVal).getTitle();
                    NoteDescription = item.get(app.ListNotes.SharedNoteKeyVal).getNoteDescription();
                } catch (Exception e) {
                ...
                Note nt = item.get(app.ListNotes.SharedNoteKeyVal);
